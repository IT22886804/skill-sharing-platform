...
public class LearningProgressService {
    ...
    //add comment
    // public LearningProgress addComment(String entryId) {
    ...
    //update comment
    public LearningProgress updateComment(String entryId, String commentId) {
        LearningProgress progress = getLearningProgressById(entryId);
    ...
    //add like
    // public LearningProgress addLike(String entryId) {
    //     LearningProgress progress = getLearningProgressById(entryId);
